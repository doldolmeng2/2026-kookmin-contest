...
class ObjectYoloNode(Node):
    def __init__(self) -> None:
        ...
        # car+traffic model; names={0:green_car,1:green_light,
        # 2:left_green_light,3:orange_light,4:red_car,5:red_light,
        # 6:traffic(body)}): 4=red_car(fixed) 0=green_car(moving).
        ...
        # 몸체 클래스(6=traffic)는 위치 판정에 쓸모가 없어 제외한다.
        self.declare_parameter("traffic_class_ids", [1, 2, 3, 5])
